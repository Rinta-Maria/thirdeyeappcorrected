...
import 'package:thireyeapp/pages/spects.dart'; // Import MyHomePage
  ...
  void signUserIn() async {
    try {
      ...
      Navigator.pushReplacement(
        ...
        email: emailController.text.trim(), // Pass email to profile page
      deviceId: 'XYZ123',    
    ...
    try {
      ...
      if (googleSignInAccount != null) {
        ...
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(builder: (context) => ProfilePage(
          email: emailController.text.trim(), // Pass email to profile page
      deviceId: 'XYZ123', // Add device ID here or retrieve it from wherever necessary
    ),
  ),
